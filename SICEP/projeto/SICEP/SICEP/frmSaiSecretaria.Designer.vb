...
Partial Class frmSaiSecretaria
    ...
    Private Sub InitializeComponent()
        ...
        Me.imgInformaçõesRegiao = New System.Windows.Forms.PictureBox
        ...
        CType(Me.imgInformaçõesRegiao, System.ComponentModel.ISupportInitialize).BeginInit()
        ...
        Me.ajuda.SetHelpString(Me.lkImprimir, "Clique sobre este link para ver a sua pesquisa de estoque em modo de impressão.")
        ...
        Me.ajuda.SetHelpString(Me.lblDiferenca, "Total de dias desde a última retirada feita em estoque para o item selecionado.")
        ...
        Me.ajuda.SetHelpString(Me.lblUltimaRetirada, "Dados da última retirada feita para este item selecionado.")
        ...
        'gpbRetirada
        '
        Me.gpbRetirada.Controls.Add(Me.imgInformaçõesRegiao)
        ...
        '
        'imgInformaçõesRegiao
        '
        Me.imgInformaçõesRegiao.BackColor = System.Drawing.Color.Transparent
        Me.ajuda.SetHelpString(Me.imgInformaçõesRegiao, "Posicione o ponteiro do mouse sobre esta imagem para ver detalhes sobre a região " & _
                "ao lado selecionada.")
        Me.imgInformaçõesRegiao.Image = Global.SICEP.My.Resources.Resources.infos
        Me.imgInformaçõesRegiao.Location = New System.Drawing.Point(313, 73)
        Me.imgInformaçõesRegiao.Name = "imgInformaçõesRegiao"
        Me.ajuda.SetShowHelp(Me.imgInformaçõesRegiao, True)
        Me.imgInformaçõesRegiao.Size = New System.Drawing.Size(21, 21)
        Me.imgInformaçõesRegiao.SizeMode = System.Windows.Forms.PictureBoxSizeMode.StretchImage
        Me.imgInformaçõesRegiao.TabIndex = 49
        Me.imgInformaçõesRegiao.TabStop = False
        '
        'lkVerEstoque
        '
        ...
        Me.ajuda.SetHelpString(Me.lkVerEstoque, "Clique aqui para ver a situação atual do estoque.")
        ...
        Me.ajuda.SetHelpString(Me.dpdRegiao, "Região para onde vai ser destinado este item.")
        ...
        Me.Label8.Text = "Região de Destino:"
        '
        'Label9
        '
        ...
        Me.Text = "Formulário para Gestão de Saídas em Estoque da Secretaria"
        ...
        CType(Me.imgInformaçõesRegiao, System.ComponentModel.ISupportInitialize).EndInit()
    ...
    Friend WithEvents imgInformaçõesRegiao As System.Windows.Forms.PictureBox
