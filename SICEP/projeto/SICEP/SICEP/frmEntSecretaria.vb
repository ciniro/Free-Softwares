...
#Region "Funcoes Privadas"
    ...
    Private Sub EfetuarEntradas()
        ...
        If txtNumLote.Text.Equals("") Then
            func.NumLote = "Não Informado!"
        Else
            func.NumLote = txtNumLote.Text
        End If
        If txtNumNota.Text.Equals("") Then
            func.NumNota = "Não Informado!"
        Else
            func.NumNota = txtNumNota.Text
        End If
...
#End Region
    ...
    Private Sub txtQuantidade_KeyPress(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles txtQuantidade.KeyPress
        ...
        End If
    End Sub
    Private Sub frmEntSecretaria_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub cmdEditarEntradas_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdEditarEntradas.Click
        frmEditaEntSecretaria.ShowDialog()
    End Sub
