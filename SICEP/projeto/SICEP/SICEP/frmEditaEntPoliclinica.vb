...
Public Class frmEditaEntPoliclinica
#Region "Funcoes Privadas"
    ...
    Private Sub PreencheFormulario()
        Try
            If grdEditarEntradas.Rows.Count > 0 Then
                ...
                lblCodEntrada.Text = est.CodigoEntrada
    ...
    End Sub
#End Region
    Private Sub frmEditaEntPoliclinica_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub lkImprimir_LinkClicked(ByVal sender As System.Object, ByVal e As System.Windows.Forms.LinkLabelLinkClickedEventArgs) Handles lkImprimir.LinkClicked
        ...
        frmRelatorios.crvVisualizador.ReportSource = rel.CriarRelEntradasPoliclinica(grdEditarEntradas.DataSource)
        frmRelatorios.Show()
    End Sub
