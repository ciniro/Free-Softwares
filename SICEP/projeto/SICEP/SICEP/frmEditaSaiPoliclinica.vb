...
Public Class frmEditaSaiPoliclinica
#Region "Funcoes Privadas"
    Private Sub PreencheGrid(ByVal med As String, ByVal val As String, ByVal DI As String, ByVal DF As String)
        Dim func As New SaidasPoliclinica
    ...
    Private Sub PreencheFormulario()
        Try
            If grdEditarEntradas.Rows.Count > 0 Then
                ...
                lblCodSaida.Text = est.CodigoSaida
    ...
    End Sub
#End Region
    Private Sub frmEditaSaiPoliclinica_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub lkImprimir_LinkClicked(ByVal sender As System.Object, ByVal e As System.Windows.Forms.LinkLabelLinkClickedEventArgs) Handles lkImprimir.LinkClicked
        ...
        frmRelatorios.crvVisualizador.ReportSource = rel.CriarRelSaidasPoliclinica(grdEditarEntradas.DataSource)
        frmRelatorios.Show()
    End Sub '-----------------------------
