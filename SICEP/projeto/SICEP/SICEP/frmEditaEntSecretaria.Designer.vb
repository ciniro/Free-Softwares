...
Partial Class frmEditaEntSecretaria
    ...
    Private Sub InitializeComponent()
        ...
        Me.ajuda.SetHelpString(Me.grdEditarEntradas, "Clique sobre a entrada procurada para carregar suas informações.")
        ...
        Me.cod_ent_sec.HeaderText = "Código da Entrada"
        ...
        Me.ajuda.SetHelpString(Me.lkImprimir, "Clique neste link para exibir a sua pesquisa em modo de impressão.")
        ...
        Me.ajuda.SetHelpString(Me.chkMateriais, "Marque esta opção para exibir apenas materiais de consumo na pesquisa.")
        ...
        Me.ajuda.SetHelpString(Me.chkMedicamentos, "Marque esta opção para exibir apenas os medicamentos na pesquisa.")
        ...
        Me.Text = "Formulário para Edição de Entradas na Secretaria"
