...
Public Class rptSaidasSecretaria
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptSaidasSecretaria.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptSaidasSecretaria
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptSaidasSecretaria = New rptSaidasSecretaria
        rpt.Site = Me.Site
        Return rpt
    End Function
