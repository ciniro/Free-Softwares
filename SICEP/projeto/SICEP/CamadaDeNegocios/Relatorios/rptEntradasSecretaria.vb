...
Public Class rptEntradasSecretaria
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptEntradasSecretaria.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptEntradasSecretaria
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptEntradasSecretaria = New rptEntradasSecretaria
        rpt.Site = Me.Site
        Return rpt
    End Function
