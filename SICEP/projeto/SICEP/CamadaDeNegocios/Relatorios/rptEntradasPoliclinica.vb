...
Public Class rptEntradasPoliclinica
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptEntradasPoliclinica.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptEntradasPoliclinica
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptEntradasPoliclinica = New rptEntradasPoliclinica
        rpt.Site = Me.Site
        Return rpt
    End Function
