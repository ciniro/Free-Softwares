...
Public Class rptSaidasPoliclinica
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptSaidasPoliclinica.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptSaidasPoliclinica
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptSaidasPoliclinica = New rptSaidasPoliclinica
        rpt.Site = Me.Site
        Return rpt
    End Function
