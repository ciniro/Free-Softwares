...
Public Class rptEstoqueSecretaria
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptEstoqueSecretaria.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptEstoqueSecretaria
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptEstoqueSecretaria = New rptEstoqueSecretaria
        rpt.Site = Me.Site
        Return rpt
    End Function
