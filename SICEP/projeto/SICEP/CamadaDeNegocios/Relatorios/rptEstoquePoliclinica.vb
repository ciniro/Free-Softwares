...
Public Class rptEstoquePoliclinica
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptEstoquePoliclinica.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptEstoquePoliclinica
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptEstoquePoliclinica = New rptEstoquePoliclinica
        rpt.Site = Me.Site
        Return rpt
    End Function
